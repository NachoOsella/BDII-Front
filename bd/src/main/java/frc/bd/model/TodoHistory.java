...
@Document(collection = "todo_history")
public class TodoHistory {
    ...
    public TodoHistory(String todoId, String userId, String text, boolean completed, Instant createdAt, Instant updatedAt, String action, Instant actionAt) {
        this.todoId = todoId;
        this.userId = userId;
        this.text = text;
